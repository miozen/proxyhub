...
```sh
# 安装指定 ProxyHub 版本
sudo /tmp/proxyhub-install.sh --version 0.1.2
...
```sh
proxyhub update proxyhub \
  --image ghcr.io/miozen/proxyhub:v0.1.2
```

非交互确认：

```sh
proxyhub update proxyhub --version 0.1.2 --yes
```
...
- 稳定镜像：`ghcr.io/miozen/proxyhub:v0.1.2`
